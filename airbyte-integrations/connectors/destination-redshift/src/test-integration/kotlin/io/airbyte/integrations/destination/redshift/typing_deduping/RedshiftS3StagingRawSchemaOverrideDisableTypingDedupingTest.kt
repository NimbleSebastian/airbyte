...
class RedshiftS3StagingRawSchemaOverrideDisableTypingDedupingTest : AbstractRedshiftTypingDedupingTest() {
  override fun getBaseConfig(): ObjectNode {
    return deserialize(readFile(Path.of("secrets/1s1t_config_staging_raw_schema_override.json"))) as ObjectNode
  }
