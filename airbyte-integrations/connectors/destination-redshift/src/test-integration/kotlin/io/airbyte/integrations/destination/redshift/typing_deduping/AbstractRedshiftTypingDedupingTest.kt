...
abstract class AbstractRedshiftTypingDedupingTest : JdbcTypingDedupingTest() {
  ...
  fun testRawTableMetaMigration_append() {
    ...
    val expectedFinalRecords2 = readRecords("dat/sync2_expectedrecords_fullrefresh_append_mixed_meta_final.jsonl")
  ...
  fun testRawTableMetaMigration_incrementalDedupe() {
    ...
    val expectedRawRecords2 = readRecords("dat/sync2_expectedrecords_mixed_meta_raw.jsonl")
    val expectedFinalRecords2 = readRecords("dat/sync2_expectedrecords_incremental_dedup_meta_final.jsonl")
    verifySyncResult(expectedRawRecords2, expectedFinalRecords2, disableFinalTableComparison())
  }
  ...
  fun testRawTableLoadWithSuperVarcharLimitation() {
    ...
    val record2 = """
                           ...
                           """.trimIndent()
    val largeString1 = generateRandomString(RedshiftSuperLimitationTransformer.REDSHIFT_VARCHAR_MAX_BYTE_SIZE)
    val largeString2 = generateRandomString(RedshiftSuperLimitationTransformer.REDSHIFT_VARCHAR_MAX_BYTE_SIZE + 2)
    val catalog = ConfiguredAirbyteCatalog().withStreams(
      List.of(
        ConfiguredAirbyteStream()
          .withSyncMode(SyncMode.FULL_REFRESH)
